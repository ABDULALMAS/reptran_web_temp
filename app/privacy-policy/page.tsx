    ...
    <div className="privacy-page">
      ...
      <section className="privacy-hero">
        <div className="pw">
          ...
          <h1>
            Your data is used to support you.
            <br />
...
We do not knowingly collect personal data from children.`}
          />
          <PrivacyBlock
            title="9. User safety and content moderation"
            text={`RepTran includes features to help maintain a safe and respectful environment.

• You can report users for spam, abuse, or inappropriate behavior  
• You can block users to prevent interaction and visibility  
• Reported content may be reviewed and action may be taken where necessary  

We aim to create a supportive environment focused on consistency and recovery, not negativity.

If you believe your account or content has been affected unfairly, you may contact: support@reptran.com`}
          />
